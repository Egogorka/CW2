...
$container[\eduslim\application\controller\SessionSocketController::class] = function (\Psr\Container\ContainerInterface $c) {
    return new \eduslim\application\controller\SessionSocketController(
        $c->get(\eduslim\domain\session\SessionManager::class),
        $c->get(\eduslim\domain\clan\ClansManager::class),
        $c->get(\eduslim\domain\user\UserManager::class)
    );
